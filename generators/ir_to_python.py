...
def py_type(value: str) -> str:
    return re.sub(
        r"\b(Channel|CharacterStyle|Clip|Composition|Document|Effect|FolderItem|FootageItem|Layer|Link|Marker|Mask|Page|ParagraphStyle|Project|ProjectItem|Selection|Sequence|SourceText|Spread|Story|Swatch|TextFrame|TextItem|TextSelection|Track)\b",
        r"\1Proxy",
        value,
    )
